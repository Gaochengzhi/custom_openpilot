...
from openpilot.tools.sim.bridge.metadrive.realdrive_bridge import RealDriveBridge # type: ignore

def create_bridge(dual_camera, high_quality):
  queue: Any = Queue()

  simulator_bridge = RealDriveBridge(dual_camera, high_quality)
...
def parse_args(add_args=None):
  ...
  parser.add_argument('--dual_camera', action='store_false')
